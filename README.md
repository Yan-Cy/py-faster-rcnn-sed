# py-faster-rcnn-sed
# Train Py-Faster-RCNN on Another Dataset(modified)
...
For example, if you want to use the model **VGG_CNN_M_1024** with alternated optimizations, then you should adapt the **solvers**(path) in `$PY_FASTER_RCNN/models/VGG_CNN_M_1024/faster_rcnn_alt_opt/`
...
*!!! Change path in solver from pascal_voc to INRIA_Person*

## Build config file

!!! copy from /experiment/cfgs/*
...
## !!!! Add module inria_eval for test
