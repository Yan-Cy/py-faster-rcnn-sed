...
if __name__ == '__main__':
    draw_rect(cfg.trainset, cfg.imgpath, cfg.rectpath, cfg.traindst, 'red', cfg.all_cls)
    draw_rect(cfg.testset, cfg.imgpath, cfg.rectpath, cfg.testdst, 'red', cfg.all_cls)
