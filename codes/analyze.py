...
filename = '/home/chenyang/sed/results/comp4_1c1ef6a1-aa7d-467f-be13-e8a082ab841c_det_train_{}.txt'
#filename = '/home/chenyang/sed/results/comp4_5d71d366-6dc2-466d-9b94-606e39d974a7_det_test_{}.txt'
annopath = '/home/chenyang/sed/data/Annotations/'
#imagesetfile = '/home/chenyang/sed/data/ImageSets/test.txt'
imagesetfile = '/home/chenyang/sed/data/ImageSets/train.txt'
...
def draw_confusion_matrix(filename, imagesetfile):
    matrix = dict()
    cls_num = len(CLASSES)
...
#        refine_roidb = [x for x in roidbs if float(x[1]) > 0.7]
...
if __name__ == '__main__':
    draw_confusion_matrix(filename, imagesetfile)
