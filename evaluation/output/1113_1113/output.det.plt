...
plot [0.01:1000] [-1.64485362793551:3.7190172740417] \
  'output.det.CellToEar_Event.dat.1' using 5:2 title 'CellToEar Eventsed1113' with  lines  lc 2 lw 1,\
  'output.det.Embrace_Event.dat.1' using 5:2 title 'Embrace Eventsed1113' with  lines  lc 3 lw 1,\
  'output.det.Pointing_Event.dat.1' using 5:2 title 'Pointing Eventsed1113' with  lines  lc 4 lw 1