...
plot [0.01:1000] [-1.64485362793551:3.7190172740417] \
  'x.det.CellToEar_Event.dat.1' using 5:2 title 'CellToEar Eventsed' with  lines  lc 2 lw 1,\
  'x.det.Embrace_Event.dat.1' using 5:2 title 'Embrace Eventsed' with  lines  lc 3 lw 1,\
  'x.det.Pointing_Event.dat.1' using 5:2 title 'Pointing Eventsed' with  lines  lc 4 lw 1